  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <section className="bg-blue-50 py-20 px-6 text-center">
        ...
        <button className="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-lg">Request Early Access</button>
      </section>
      ...
      <section className="bg-blue-50 py-16 px-6 text-center">
        ...
        <button className="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition text-lg">Start Free Trial</button>
      </section>
